...
(function ($, window, document) {
  ...
  const sliderMain = function () {
    ...
    $owl.owlCarousel({
      ...
      ], // by default text prev, next will not show
    });
  };
  /**
...
(function ($, window, document) {
  ...
  const googleinitMap = function () {
    ...
    let mapOptions = {
      ...
      center: new google.maps.LatLng(37.393322, -122.02378),
    };
    ...
    let marker = new google.maps.Marker({
      position: new google.maps.LatLng(37.393322, -122.02378),
      map: map,
    });
  };
